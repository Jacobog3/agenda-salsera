...
export async function generateMetadata() {
  return { title: "Publicar Bar / Lugar | ExploraGuate" };
}
  ...
  return (
    <section className="page-section pb-16">
      <Container className="max-w-2xl space-y-6">
        <SectionHeading
          icon={MapPinned}
          title="Publicar bar / lugar"
          description="Registrá tu bar o lugar donde hay salsa y bachata seguido."
        />
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-gray-500">
                El formulario para registrar bares y lugares está en desarrollo. Mientras tanto
                escribinos y con gusto te agregamos.
              </p>
            </div>
            <a
