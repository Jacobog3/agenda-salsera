    ...
    <div className="flex items-center justify-center gap-3">
      {links.map((link) => (
        <a
          ...
          className={`inline-flex h-12 w-12 items-center justify-center rounded-full shadow-sm transition-all active:scale-[0.98] ${iconMap[link.type].className}`}
        >
          {iconMap[link.type].icon}
        </a>
      ))}
    </div>
  );
