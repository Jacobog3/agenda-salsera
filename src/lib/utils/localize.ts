...
export function localizeTeacher(
  ...
  return {
    ...
    profileKind: teacher.profileKind,
    professionalRoles: teacher.professionalRoles,
    nationalityCountryCode: teacher.nationalityCountryCode,
    sourceUrl: teacher.sourceUrl,
    sourceLabel: teacher.sourceLabel,
